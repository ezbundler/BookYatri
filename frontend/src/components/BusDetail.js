...
const BusDetail = ({ busId ,onClose}) => {
  ...
  return (
    <div className="p-8 bg-white rounded-2xl  mt-4 flex gap-8">
      <ToastContainer />
      ...
      <div className="w-2/3">
        ...
        {isEditing ? (
          <div>
            ...
            <button
              onClick={handleSave}
              className="bg-yellow-400 text-gray-800 p-2 rounded hover:bg-yellow-500 mr-2 shadow-md"
            >
              Save
            </button>
            <button
              onClick={() => setIsEditing(false)}
              className="bg-gray-300 text-gray-800 p-2 rounded hover:bg-gray-400 shadow-md"
            >
              Cancel
            </button>
          </div>
          ...
          <div>
            ...
            <button
              ...
              className="bg-red-600 text-white p-2 rounded hover:bg-red-700 shadow-md"
            >
              Delete
            </button>
          </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-gray-100 p-6 rounded shadow-lg">
              ...
              <button
                ...
                className="bg-red-600 text-white p-2 rounded hover:bg-red-700 shadow-md mr-2"
              >
                Delete
              </button>
              <button
